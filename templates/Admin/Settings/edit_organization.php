 ...
 */
$this->assign('title', 'Editar Organización');
?>
        ...
        <div class="form-content">
            ...
            <div class="info-text">
                <p>
                    ...
                    Cambiar el nombre de la organización no afectará a los usuarios asociados.
                </p>
            </div>
            ...
            <div class="form-actions">
                ...
                <?= $this->Form->button(
                    '<i class="bi bi-check-circle"></i> Actualizar Organización',
